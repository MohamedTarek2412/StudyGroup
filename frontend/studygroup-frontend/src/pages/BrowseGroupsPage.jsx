...
const BrowseGroupsPage = () => {
  const { groups, loading, error, browseParams, updateBrowseParams, resetBrowseParams, reload } =
    useGroups({ autoLoad: true, initialBrowseParams: { subject: "", search: "", location: "", meetingTime: "", creatorName: "" } });
    ...
    <div className="container mt-6">
      ...
      <div className="card mb-4" style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
        ...
        <GroupFilters
          ...
          creatorName={browseParams.creatorName}
          onChangeCreatorName={(val) => updateBrowseParams({ creatorName: val })}
          subjects={subjects}
          disabled={loading}
          onClear={() => {
            resetBrowseParams();
